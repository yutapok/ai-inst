...
1. **Check Architectural Violation Vectors**
   ...
   - *(Required skill: `.antigravity/skills/architecture/SKILL.md`)*
...
4. **Output Report and Stop**
   - Output the artifact to `.antigravity/reports/drift-report-latest.md` using the format below and **STOP** working.

---

## Output Format (`.antigravity/reports/drift-report-latest.md`)
