...
This workflow scans the current project structure to discover implicit architectural patterns and initialize the governance framework (`ANTIGRAVITY.md` and a baseline ADR).
...
3. **Initialize Governance Files**
   - **`ANTIGRAVITY.md`**: Draft base architectural guardrails (Dependency Direction, No Cyclic Dependencies, etc.) tailored to the discovered structure.
...
4. **Output Discovery Report**
   ...
   - Output the discovery report to `.antigravity/reports/arch-discovery-latest.md`.
   - **STOP** and wait for human confirmation.

---

## Output Format (`.antigravity/reports/arch-discovery-latest.md`)
...
## Drafted Governance
- [Link to drafted ANTIGRAVITY.md]
