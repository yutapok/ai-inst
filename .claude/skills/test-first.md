...
# Test-First Expansion Procedure for Claude Code

Once a "Tracer Bullet" (minimal end-to-end path) is proven to work, you must nurture it into production-ready code. Do this by strictly detailing specifications as tests in the following order:
...
- Critically: Verify that the exact "error exit codes" and "error output formatting" defined in the CLI Contract integration test are adhered to.
