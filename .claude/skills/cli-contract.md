...
# CLI Contract Definition for Claude Code
...
- Continuously run these integration tests during your development loop (e.g., `go test tests/integration/...`).
- If the integration test fails after the initial Tracer Bullet phase, you have broken the contract.
- Fix the internal changes until the test passes again before declaring the task complete.
