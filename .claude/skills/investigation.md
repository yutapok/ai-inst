...
# Investigation Methodology for Claude Code

As an AI agent, you must not hallucinate or guess the state of the codebase. Strictly follow these steps before modifying code:
...
- Propose the concrete scope of a Tracer Bullet (minimal viable path) to the user or execute it locally to prove the hypothesis.
