...
- **Implied ADR Formalization**: Review any temporary files in `.agent/reports/tmp/implied-adr/implied-adr-*.md`. Determine if these decisions should be promoted to a formal ADR, modified, or discarded.
