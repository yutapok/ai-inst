---
description: [Phase 3] Perform an architecture drift check, and draft an ADR if necessary.
---
...
4. **Output Report and Stop**
   - Output the artifact using the `drift_report.md` format below and **STOP** working.

---

## Output Format (`drift_report.md`)
