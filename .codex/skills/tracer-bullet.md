...
# Tracer Bullet Methodology for Autonomous Agents
...
- **Run Locally**: Rely on automated testing and your terminal execution powers to run the code. Confirm it produces the intended result (Proof of Viability). Read the output.
...
- **Do Not Exhaustively Handle Edge Cases**: Full coverage of validation and abnormal behavior handling should be deferred to the Expand phase.
