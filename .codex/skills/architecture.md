...
# Architecture Governance for Autonomous Agents
...
1. **HALT** any file modifications for this feature immediately. Do not commit or execute destructive actions.
2. Formulate an **Architecture Decision Record (ADR)** to propose to the user.
3. Use the following format for the proposed ADR in your console/chat output:
...
4. Await human instruction to proceed.
